...
public class AnnotationScopeMetadataResolver implements ScopeMetadataResolver {
	 ...
	 * 构造一个新的AnnotationScopeMetadataResolver
	 ...
	 * 使用默认的范围代理模式 构造一个新的AnnotationScopeMetadataResolver
